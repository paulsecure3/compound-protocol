...
/**
  * @title Loanshark's DAIInterestRateModel Contract (version 3)
  * @author Loanshark
  * @notice The parameterized model described in section 2.4 of the original Loanshark Protocol whitepaper.
